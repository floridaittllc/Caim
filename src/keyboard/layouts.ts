...
export const LETTER_ROWS: KeyboardRow[] = [
  ...
  [
    special("layer-numbers", "123", 1.25),
    char(",", undefined, 1),
    special("left", "←", 1),
    special("space", "space", 3.4),
    special("right", "→", 1),
    char(".", undefined, 1),
    special("enter", "return", 1.45),
  ],
];
...
export const NUMBER_ROWS: KeyboardRow[] = [
  ...
  [
    special("shift", "shift", 1.3),
    special("layer-symbols", "#+=", 1.3),
    char("."),
    char(","),
    char("?", "¿"),
    char("!", "¡"),
    char("'"),
    special("backspace", "delete", 1.3),
  ],
  [
    special("layer-letters", "ABC", 1.2),
    special("tab", "tab", 1),
    special("home", "home", 1),
    special("space", "space", 3.2),
    special("end", "end", 1),
    special("enter", "return", 1.4),
  ],
];
